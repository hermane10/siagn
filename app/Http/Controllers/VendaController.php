...
class VendaController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	if($request){
            ...
            ->select('v.idvenda', 'v.data_hora', 'p.nome', 'v.tipo_comprovante',
             'v.serie_comprovante', 'v.num_comprovante', 'v.taxa', 'v.estado', 'v.total_venda')
            ->where('estado', '=', 'A')
    ...
    public function create(){
        ...
        ->select(DB::raw('CONCAT(pro.nome, "   -   ", pro.codigo) As produto'),
        'pro.idproduto', 'pro.estoque',
