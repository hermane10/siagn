		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="row">
            	...
            	<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    ...
                    <input type="text" name="serie_comprovante"
                    required value="{{old('serie_comprovante')}}"
                    class="form-control" placeholder="Série do comprovante...">
	            	</div>
            	...
            	<div class="col-lg-4 col-sm-4 col-xs-12">
                        ...
                        <input type="text" name="num_comprovante"
                        required value="{{old('num_comprovante')}}" class="form-control"
